# DEPRECATED — archived 2026-04-26
# This file is the original 4-tab app (goods demand, scaling functions, strata simulation, alpha designer).
# Tabs 1-3 are no longer maintained. The active app is app.py (2-tab version).
