# Stable SOL Rebuild (2026-04-02)

## Background

The previous Global SOL implementation recalculated all countries and ranked them every monthly tick. This was expensive and provided limited gameplay value for the EU5 timeline.

## Rebuild Goals

1. Move repeated country-internal calculations out of per-location script values.
2. Remove global ranking logic and redesign UI for current-country decision support.
...
File: `src/stable/in_game/gui/panels/situation/global_living_standard.gui`
...
File: `src/stable/in_game/common/situations/global_living_standard.txt`
...
- `src/stable/in_game/common/script_values/global_living_standard.txt`
- `src/stable/in_game/common/scripted_effects/global_living_standard_effects.txt`
- `src/stable/in_game/common/situations/global_living_standard.txt`
- `src/stable/in_game/common/resolutions/global_living_standard_resolution.txt`
- `src/stable/in_game/gui/panels/situation/global_living_standard.gui`
- `src/stable/main_menu/localization/simp_chinese/global_living_standard_l_simp_chinese.yml`
- `src/stable/main_menu/localization/english/global_living_standard_l_english.yml`
