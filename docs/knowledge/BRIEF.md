...
| --- | --- | --- | --- |
| `scripts/gen_sol_chain.py` | data/target_demand.csv + vanilla goods | active SOL generated files for stable/sol_standalone | Preferred one-shot SOL generation entry; build.bat runs it automatically |
