...
| `scripts/sol_country_demand_solver_source.py` | Renderer for the separate country-level exact diagnostic, player four-strategy nonnegative hard-total solver, AI `proportional_fast` output, and retained minimax vertices; it keeps the fixed-dimensional KKT and reduced minimax blocks out of the location aggregation file |
