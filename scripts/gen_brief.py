...
def main():
    ...
    lines.append(
        f"> Edit `docs/knowledge/anti_patterns.yaml` or `valid_enums.yaml`, "
        f"then run `python scripts/gen_brief.py`.  "
    )
    ...
    print(f"[OK] Generated {OUTPUT.relative_to(REPO_ROOT)} ({len(anti_patterns)} patterns, {len(enums)} enums)")
